      ...
      <div className="container-max px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
            ...
            <div className="flex gap-3">
              {socialLinks.map(({ icon: Icon, label, href }) => (
                <motion.a
                  ...
                  href={href}
                  title={label}
                  className="w-9 h-9 rounded-lg bg-slate-800/50 border border-slate-700 flex items-center justify-center text-slate-400 hover:text-primary-400 hover:border-primary-500/50 hover:bg-primary-500/10 transition-all duration-200"
              ...
              <ul className="space-y-2.5">
                {section.links.map((link) => (
                  <li key={link.label}>
                    <a
                      href={link.href}
                      className="text-sm text-slate-400 hover:text-primary-400 transition-colors duration-200 inline-flex items-center gap-1 group"
                    >
                      {link.label}
        ...
        >
          <p className="text-xs sm:text-sm text-slate-500">
            © {currentYear} Ebuka Portfolio. All rights reserved.
          </p>

          <div className="flex items-center gap-6">
            <a href="#" className="text-xs text-slate-500 hover:text-slate-400 transition-colors duration-200">
              Privacy
            </a>
            <a href="#" className="text-xs text-slate-500 hover:text-slate-400 transition-colors duration-200">
              Terms
            ...
            <motion.button
              ...
              className="text-xs text-slate-500 hover:text-primary-400 transition-colors duration-200 flex items-center gap-1"
              whileHover={{ y: -2 }}
            >
              Back to top ↑
            </motion.button>
